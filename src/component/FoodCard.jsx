    ...
    <div className='font-bold w-[250px] bg-white p-5 flex flex-col rounded-lg gap-2'>
        ...
        <div className='text-sm flex justify-between '>
            ...
            <div className='flex justify-between'>
                ...
                <button onClick={()=>{dispatch(addToCart({id,name,price,img,rating,qty:1})); handleToast(name)}} className='p-1 text-white bg-green-500 rounded-lg hover:bg-green-600 text-sm'>Add to cart</button>
            </div>
